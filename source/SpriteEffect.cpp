...
namespace Duel6 {
    const SpriteEffect::SpriteEffectDefinition SpriteEffect::BLINK_RED(Color::RED, 10.0f, Color::ZERO, 10.0f);
    ...
    const SpriteEffect::SpriteEffectDefinition SpriteEffect::BLINK_RED_DOUBLE(Color::RED, 10.0f, Color::ZERO, 0.1f, Color::RED, 0.2f);
